                        ...
                        <div class="row">
                            <div class="col">
                              <div class="row gx-3">
                                ...
                                <div class="col-3 ">
                                  <label for="passaportFito" class="form-label">passaportFito</label>
                                  <input type="text" class="form-control" id="passaportFito" name="passaportFito" placeholder="" value="{{$especy->passaportFito}}" required>
                                </div>
                                ...
                                <div class="col-3 ">
                                  <label for="espTempGermOptima" class="form-label">TempGerminació Optima</label>
                                ...
                                <div class="col-3 ">
                                  <label for="espNumLlavorsGr" class="form-label">Numero Llavors Germinació</label>
