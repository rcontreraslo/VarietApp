<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Editar Provincia:  {{$provincy-> name}}
        </h2>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3">
               ...
               <div class="row g-5">
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <form action="{{ route('provincies.update',$provincy->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col">
                              <div class="row gx-3">
                                ...
                                <div class="col-3 ">
                                  ...
                                  <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="" value="{{$provincy->name}}">
                                  @error('name')
