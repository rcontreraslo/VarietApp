              ...
              <div class="card-footer text-end">
                <form action="{{ route('provincies.destroy',$provincy->id) }}" onsubmit="return confirm('Confirmes que vols eliminar el registre?');" method="POST">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-sm btn-outline-primary" href="{{ route('provincies.edit',$provincy->id) }}"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                    </div>
                </form>
              </div>
            </div>
